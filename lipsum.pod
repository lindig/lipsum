...
Emit list of available source code position formats. The best knwon format 
is C<cpp> as it is used by the C preprocessor cpp(1).
...
B<Lipusm> exists with 0 on success and a positive number otherwise.
